...
/**
 * Step 3: Bank Guarantee Excel Data Storage
 * Uploaded by Finance module for bank guarantee processing
 */
@Entity
@Table(name = "bank_guarantee_data")
public class BankGuaranteeData {
    ...
    private String uploadedBy; // Finance user
